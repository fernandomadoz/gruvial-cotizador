...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-cubes"></i> Gruvial</span>
    </a>
        ...
        <?php if (in_array($nivel_de_acceso, $permiso_supervisor)) { ?>
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo env('PATH_PUBLIC')?>crear-trabajo"><i class="fa fa-file-text-o"></i> Crear Trabajo</a></li>  
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Trabajo_encabezado/0"><i class="fa fa-list"></i> Listado de Cotizaciones</a></li>   
            </ul>
          </li>
          ...
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo env('PATH_PUBLIC')?>crear-cotizacion"><i class="fa fa-file-text-o"></i> Crear Cotizacion</a></li>  
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Cotizacion_encabezado/7"><i class="fa fa-list"></i> Listado de Cotizaciones</a></li>   
            </ul>
          </li>
          ...
          <li class="active treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Maquina/0"><i class="fa fa-truck"></i> Maquinas</a></li>       
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Tipo_de_maquina/0"><i class="fa fa-list"></i> Tipos de maquina</a></li>   
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Unidad_de_trabajo/0"><i class="fa fa-list"></i> Unidades de trabajo</a></li> 
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Parametro/0"><i class="fa fa-list"></i> Parametros</a></li>   
            </ul>
          </li>
